...
public class VRNetworkManager : Photon.MonoBehaviour {
	...
	public virtual void Start()
	{
		...
		var temp = PhotonVoiceNetwork.Client; //to activate photon voice
	}
	...
	public virtual void OnPhotonRandomJoinFailed()
	{
		...
		PhotonNetwork.CreateRoom(null, new RoomOptions() { MaxPlayers = 12 }, null);
	}
